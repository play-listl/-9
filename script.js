document.addEventListener('DOMContentLoaded', function() {
    ...
    const points = {
        'The State Funeral of Elizabeth II': [20, 12, 8, 6, 4, 3, 2, 0],
        'The 1996 Summer Olympics Opening Ceremony': [16, 16, 11, 7, 5, 4, 2, 1],
        'The Funeral of Princess Diana': [12, 12, 14, 9, 7, 5, 3, 2],
        'The Funeral of Michael Jackson': [10, 10, 11, 12, 8, 6, 4, 4],
        'Leon Spinks vs. Muhammad Ali II': [8, 8, 8, 9, 11, 8, 5, 5],
        'Live Aid': [6, 6, 7, 7, 8, 10, 7, 5],
        '2022 FIFA World Cup Final': [5, 5, 5, 6, 7, 9, 9, 7],
        '“Aloha from Hawaii via Satellite”': [4, 4, 4, 4, 5, 6, 7, 8]
    };

    const correctOrder = [
        { city: 'The State Funeral of Elizabeth II', year: '4 Billion' },
        { city: 'The 1996 Summer Olympics Opening Ceremony', year: '3.5 Billion' },
        { city: 'The Funeral of Princess Diana', year: '2.5 Billion' },
        { city: 'The Funeral of Michael Jackson', year: '2.5 Billion' },
        { city: 'Leon Spinks vs. Muhammad Ali II', year: '2 Billion' },
        { city: 'Live Aid', year: '1.9 Billion' },
        { city: '2022 FIFA World Cup Final', year: '1.5 Billion' },
        { city: '“Aloha from Hawaii via Satellite”', year: '1.5 Billion' }
    ];
